...
func (p *SettingsPage) Name() string { return i18n.T("tab.settings") }
	...
	return layout.Flex{Axis: layout.Vertical}.Layout(gtx,
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return layout.Inset{Top: unit.Dp(8)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
				return material.H6(p.th, i18n.T("settings.logging.title")).Layout(gtx)
			})
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return p.inputWithLabelAndSave(gtx, i18n.T("settings.log_limit.label"), &p.logLimitEditor, &p.logLimitSave)
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return material.CheckBox(p.th, &p.showLogs, i18n.T("settings.show_logs")).Layout(gtx)
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return material.CheckBox(p.th, &p.desktopNotif, i18n.T("settings.desktop_notifications")).Layout(gtx)
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return layout.Inset{Top: unit.Dp(16)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
				return material.H6(p.th, i18n.T("settings.config.title")).Layout(gtx)
			})
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return p.inputWithLabelAndSave(gtx, i18n.T("settings.default_interval.label"), &p.intervalEditor, &p.intervalSave)
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return layout.Inset{Top: unit.Dp(16)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
				return material.H6(p.th, i18n.T("settings.language.title")).Layout(gtx)
			})
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return layout.Inset{Top: unit.Dp(8)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
				...
				return material.Button(p.th, &p.langBtn, i18n.LanguageName(lang)).Layout(gtx)
			})
		}),
	)
}
...
func (p *SettingsPage) openLangPicker() {
	...
	p.dialog.ShowCustom(i18n.T("settings.language.title"), func(gtx layout.Context) layout.Dimensions {
		for i := range langs {
...
func (p *SettingsPage) inputWithLabelAndSave(gtx layout.Context, label string, ed *widget.Editor, saveBtn *widget.Clickable) layout.Dimensions {
	return layout.Flex{Axis: layout.Horizontal, Alignment: layout.Middle}.Layout(gtx,
		...
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return material.Button(p.th, saveBtn, i18n.T("settings.btn.save")).Layout(gtx)
		}),
	)
}
