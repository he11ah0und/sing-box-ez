...
func NewMainPage(th *material.Theme, ctrl *core.Controller) *MainPage {
	return &MainPage{
		th:   th,
		ctrl: ctrl,
	}
	...
	return layout.Flex{Axis: layout.Vertical}.Layout(gtx,
		...
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return layout.Inset{Top: unit.Dp(8), Bottom: unit.Dp(8)}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
				text := i18n.T("main.active.none")
				if active != nil {
					text = i18n.T("main.active.prefix") + active.Name
				}
				return material.Body2(p.th, text).Layout(gtx)
			})
		}),
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
